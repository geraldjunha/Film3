...
import id.sch.smktelkom_mlg.privateassignment.xirpl117.film3d.Sugar.Place;


public class HomeActivity extends AppCompatActivity {
    private static final String URL_DATA = "https://api.themoviedb.org/3/discover/movie?sort_by=popularity.desc&api_key=e211cdab766a4317aaf48307c3b818ae";
...
//        });
        ...
        btnRate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isPressed) {
                    doSave();
                    Snackbar.make(view, "Rating Berhasil", Snackbar.LENGTH_LONG)
